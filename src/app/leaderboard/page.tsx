      ...
      <div className="text-center mb-6 lg:mb-12">
        <div className="flex items-center justify-center gap-4 lg:gap-6 mb-3 lg:mb-6">
          ...
          <div className="flex flex-col items-center">
            <span className="text-[#003DA5] font-bold text-xl lg:text-3xl tracking-tight">BOUYGUES</span>
            <span className="text-[#003DA5] font-light text-sm lg:text-lg tracking-widest">TELECOM</span>
          </div>
